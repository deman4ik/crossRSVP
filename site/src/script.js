(() => {
  const russian = {
    ...
    "navUnlock": "Заблокированное устройство",
    ...
    "downloadText": "Для каждой модели устройства нужен свой файл прошивки. X3 и X4 используют прежний способ обновления широкой строки; X4 Pro — ускоренный способ, проверенный на устройстве.",
    "unavailable": "Для этой модели пока нет файла прошивки.",
    "view": "Открыть релизы ↗",
    "download": "Скачать .bin ↓",
    "notes": "Что нового ↗",
    "allReleases": "Все версии на GitHub ↗",
    "unlockEyebrow": "Заводская прошивка",
    "unlockTitle": "Прошивка по USB<br><em>недоступна?</em>",
    "unlockText": "На некоторых ридерах Xteink прошивка по USB отключена. У CrossPoint есть отдельные инструкции по установке своей прошивки на такие устройства. Выберите инструкцию для вашей модели.",
    "unlockNote": "Unlocker официально поддерживает CrossPoint и CrossInk. CrossRSVP — отдельная прошивка, которой нет в списке поддерживаемых.",
    "unlockSdTitle": "Начните с SD-карты",
    "unlockSdText": "CrossPoint объясняет, как установить CrossPoint с SD-карты на заблокированные X3 и X4. Этот способ не включает прошивку по USB.",
    "unlockSdLink": "Открыть инструкцию CrossPoint ↗",
    "unlockOtaTitle": "Используйте OTA Unlocker",
    "unlockOtaText": "Для X4 Pro CrossPoint рекомендует OTA Unlocker вместо установки с SD-карты. Следуйте инструкции для этой модели.",
    "unlockOtaLink": "Открыть OTA Unlocker CrossPoint ↗",
    ...
    "firstInstall": "На устройстве заводская прошивка? Начните с <a href=\"https://github.com/crosspoint-reader/crosspoint-reader#install-firmware\">инструкции CrossPoint ↗</a>. Если прошивка по USB недоступна, сначала прочитайте <a href=\"#unlock\">раздел о заблокированных устройствах</a>.",
