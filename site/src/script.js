(() => {
  const russian = {
    ...
    "focusText": "В режиме RSVP слова из книги появляются по очереди. Одна буква в каждом слове выделена и находится в одной точке экрана — на ней можно удерживать взгляд.",
    ...
    "downloadText": "Для каждой модели устройства нужна своя прошивка.",
