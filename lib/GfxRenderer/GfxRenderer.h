...
class GfxRenderer {
 ...
 public:
  ...
  void ensureSdCardFontReady(int fontId, const char* const* utf8Texts, size_t textCount,
                             uint8_t styleMask = 0x0F) const;
  void ensureSdCardFontReady(int fontId, const char* const* utf8Texts, size_t textCount,
                             SdCardFont::AdvanceBuildScratch& scratch, uint8_t styleMask = 0x0F) const;
  bool reserveSdCardFontAdvanceTable(int fontId, uint8_t styleMask = 0x0F,
                                     uint32_t capacity = SdCardFont::ADVANCE_BUILD_SCRATCH_CODEPOINTS) const;
