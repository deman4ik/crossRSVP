...
> [X3 installation and rollback guide](docs/rsvp-x3-v0.1-installation.md) before flashing it. The
...
| Восстановление позиции | Обычный прогресс страницы | Дополнительная версионированная RSVP-точка сохранения без замены нативного прогресса |
...
1. Установите экспериментальную сборку по [инструкции для X3](docs/rsvp-x3-v0.1-installation.md) и откройте EPUB.
...
в [отчёте X3 v0.1](docs/qualification/rsvp-x3-v0.1/README.md).
