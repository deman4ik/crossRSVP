...
[Сайт и демонстрация RSVP](https://deman4ik.github.io/crossRSVP/) · [GitHub Releases](https://github.com/deman4ik/crossRSVP/releases)

В `master` версия **0.7.0** добавляет русский/английский язык группировки для каждой книги:
один компаньон до 7 букв или два до 5 букв каждый, 48 английских форм и внутренние апострофы.
Выбор **Авто / Русский / Английский** сохраняется независимо от языка меню и общего переключателя
группировки. [Проверки и оставшиеся испытания на устройствах](docs/rsvp-v0.7.0-validation.md).
Публичный предварительный релиз v0.6.0 остаётся отдельной предыдущей сборкой.
