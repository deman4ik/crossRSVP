...
> [!WARNING]
> The current crossRSVP v0.4.0 build in this fork is an **experimental candidate for Xteink X3 / EPUB**.
> It is not physically qualified for any device. Read the
> [v0.4.0 qualification status](docs/qualification/rsvp-x3-v0.4.0/README.md) and
> [v0.4.0 installation and rollback guide](docs/rsvp-x3-v0.4.0-installation.md) before flashing it. The
...
Текущий кандидат предназначен для проверки на **Xteink X3 и EPUB**, но физическая квалификация ещё не заявлена.

### Как включить и использовать RSVP

1. Установите экспериментальную сборку по [инструкции для X3](docs/rsvp-x3-v0.4.0-installation.md) и откройте EPUB.
...
Опция **Настройки → Чтение → Группировка коротких слов** по умолчанию выключена. При включении кадр может содержать
...
в [статусе v0.4.0](docs/qualification/rsvp-x3-v0.4.0/README.md).
