...
> [!WARNING]
> CrossRSVP v0.5.0 is prepared for Xteink X3, the original X4, and X4 Pro. Physical
> qualification is still pending. Read the [device audit](docs/rsvp-device-audit.md)
> and [v0.5.0 installation and rollback guide](docs/rsvp-release-installation.md)
...
возможности базовой прошивки. CrossRSVP v0.5.0 добавляет режим RSVP для EPUB на Xteink X3, оригинальном X4 и X4 Pro:
...
Физическая квалификация v0.5.0 ещё не заявлена. Образы подписаны моделью: X3 и оригинальный X4 используют разные
...
1. Установите образ своей модели по [инструкции v0.5.0](docs/rsvp-release-installation.md) и откройте EPUB.
...
в [отчёте v0.5.0](docs/rsvp-v0.5.0-validation.md), а образы и контрольные суммы —
в [release notes](docs/rsvp-release-notes.md). Публикация GitHub Release требует отдельного подтверждения.
